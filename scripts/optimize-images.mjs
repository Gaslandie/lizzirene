...
const images = [
  ...
  {
    source: 'produits/grand-ours-beige.jpeg',
    nom: 'produit-grand-ours-beige',
    largeurs: [480, 810],
    qualite: 82,
  },
  {
    source: 'produits/grand-ours-blanc.jpeg',
    nom: 'produit-grand-ours-blanc',
    largeurs: [480, 810],
    qualite: 82,
  },
  {
    source: 'produits/grand-ours-rose.jpeg',
    nom: 'produit-grand-ours-rose',
    largeurs: [480, 810],
    qualite: 82,
  },
  {
    source: 'produits/grand-ours-marron.jpeg',
    nom: 'produit-grand-ours-marron',
    largeurs: [480, 810],
    qualite: 82,
  },
  {
    source: 'produits/grand-ours-violet.jpeg',
    nom: 'produit-grand-ours-violet',
    largeurs: [480, 810],
    qualite: 82,
  },
  {
    source: 'produits/tableau-cheval-gris.jpeg',
    nom: 'produit-tableau-cheval-gris',
    largeurs: [480, 810],
    qualite: 82,
  },
  {
    source: 'produits/tableau-pivoines-roses.jpeg',
    nom: 'produit-tableau-pivoines-roses',
    largeurs: [480, 810],
    qualite: 82,
  },
  {
    source: 'produits/tableau-feuilles-monstera.jpeg',
    nom: 'produit-tableau-feuilles-monstera',
    largeurs: [480, 810],
    qualite: 82,
  },
  {
    source: 'produits/tableau-horloge-femme-rouge.jpeg',
    nom: 'produit-tableau-horloge-femme-rouge',
    largeurs: [480, 810],
    qualite: 82,
  },
  {
    source: 'produits/tableau-cerf-dore.jpeg',
    nom: 'produit-tableau-cerf-dore',
    largeurs: [480, 810],
    qualite: 82,
  },
  {
    source: 'produits/tableau-elephant-bleu-or.jpeg',
    nom: 'produit-tableau-elephant-bleu-or',
    largeurs: [480, 810],
    qualite: 82,
  },
  {
    source: 'produits/tableau-femme-fleurs-blanches.jpeg',
    nom: 'produit-tableau-femme-fleurs-blanches',
    largeurs: [480, 810],
    qualite: 82,
  },
  {
    source: 'produits/tableau-femme-robe-orange.jpeg',
  ...
  {
    source: 'nosServices/salle-conference.png',
    nom: 'service-salle-conference',
    largeurs: [480, 800, 1280],
    qualite: 78,
  },
  {
    source: 'nosServices/evenement-professionnel.png',
    nom: 'service-evenement-professionnel',
    largeurs: [480, 800, 1280],
    qualite: 78,
  },
  {
    source: 'nosServices/inauguration.png',
    nom: 'service-inauguration',
    largeurs: [480, 800, 1280],
    qualite: 78,
  },
  {
    source: 'nosServices/conseil-amenagement-floral.png',
    nom: 'service-conseil-amenagement-floral',
    largeurs: [480, 800, 1280],
    qualite: 78,
  },
  {
    source: 'nosServices/box-cadeau.png',
    nom: 'service-box-cadeau',
    largeurs: [480, 800, 1280],
    qualite: 78,
  },
  {
    source: 'nosServices/accueil-fleuri.png',
    nom: 'service-accueil-fleuri',
    largeurs: [480, 800, 1280],
    qualite: 78,
  },
  {
    source: 'nosServices/atelier-creation-florale.png',
    nom: 'service-atelier-creation-florale',
    largeurs: [480, 800, 1280],
    qualite: 78,
  },
  {
    source: 'nosServices/emballage-conservation.png',
    nom: 'service-emballage-conservation',
    largeurs: [480, 800, 1280],
    qualite: 78,
  },
  {
    source: 'nosServices/bapteme.png',
    nom: 'service-bapteme',
    largeurs: [480, 800, 1280],
    qualite: 78,
  },
