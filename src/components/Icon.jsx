...
const OUTLINE = {
  ...
  maison: (
    <>
      ...
      <path d="M9.6 21v-5.8h4.8V21" />
    </>
  ),
  ecran: (
    <>
      <rect x="2.5" y="3.5" width="19" height="12.5" rx="2" />
      <path d="M12 16v4.5" />
      <path d="M8.5 20.5h7" />
      <path d="M7 12.2l3-3.2 2.4 2.4 4.6-4.6" />
    </>
  ),
  groupe: (
    <>
      ...
      <path d="M16.4 5.2a3.3 3.3 0 0 1 0 5.9" />
      <path d="M17.8 14.9c2.1.7 3.4 2.5 3.4 5.1" />
    </>
  ),
  bouquet: (
    <>
      <circle cx="8.4" cy="6.4" r="2.5" />
      <circle cx="15.6" cy="6.4" r="2.5" />
      <circle cx="12" cy="4.1" r="2.5" />
      <path d="M9.6 8.7 11.2 13.6M14.4 8.7 12.8 13.6M12 6.6v7" />
      <path d="M8.4 13.6h7.2l-1.4 7.3h-4.4z" />
    </>
  ),
  diplome: (
    <>
      <path d="M12 3.6 2.6 8.2 12 12.8l9.4-4.6z" />
      <path d="M6.6 10.5V16c0 1.6 2.4 2.8 5.4 2.8s5.4-1.2 5.4-2.8v-5.5" />
      <path d="M21.4 8.2v5.4" />
    </>
  ),
  heart: (
    <path d="M12 20.4 4.6 13.2a4.9 4.9 0 0 1 7.4-6.4 4.9 4.9 0 0 1 7.4 6.4z" />
  ),
  etoile: (
  ...
  goutte: (
    <path d="M12 2.7 6.7 9.2a6.8 6.8 0 1 0 10.6 0z" />
  ),
  info: (
    <>
      <circle cx="12" cy="12" r="9" />
